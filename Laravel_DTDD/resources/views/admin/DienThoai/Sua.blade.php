            ...
            <div class="row">
                ...
                <div class="col-5">
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="text" disabled id="phoneID">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th colspan="2">Thời gian khuyến mãi:</th>
                        </tr>
                        <tr>
                            <td>Từ ngày:</td>
                        ...
                        <tr>
                            <td colspan="2">
                                <img src="DiDongZin/assets/img/undraw_photo_4yb9.svg" id="ImageReview2">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td>
                                <input type="reset" value="Hủy" onclick="loadPage('_dienthoai.html')">
                            </td>
                            <td>
