    ...
    public function postThem(Request $request)
    {
        ...
        $this->validate($request, 
            [
                ...
                'cameraSau'=>'required|numeric',
                'cameraTruoc'=>'required|numeric',
                'wifi'=>'max:50',
                'bluetooth'=>'max:50',
                'nfc'=>'max:50',
            ...
            [
                ...
                'trongLuong.numeric'=>'Trọng lượng phải được nhập số (đơn vị là gam)',
                
                'ram.required'=>'RAM không được trống',
                'ram.numeric'=>'RAM chỉ được nhập số (đơn vị là GB)',
                
                'rom.required'=>'ROM không được trống',
                'rom.numeric'=>'ROM chỉ được nhập số (đơn vị là GB)',
                ...
                'cameraSau.required'=>'Camera Sau không được trống',
                'cameraSau.numeric'=>'Camera Sau chỉ được nhập số (đơn vị là Mpx)',
                
                'cameraTruoc.required'=>'Camera Trước không được trống',
                'cameraTruoc.numeric'=>'Camera Trước chỉ được nhập số (đơn vị là Mpx)',
                ...
                'pin.required'=>'Pin không được trống',
                'pin.numeric'=>'Pin chỉ được nhập sô (đơn vị là mAh)',
                ...
                'giaBan.numeric'=>'Giá bán chỉ được nhập số',
